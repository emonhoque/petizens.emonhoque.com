...
<main class="main-content">
    ...
    <div class="termsflex">
        <div class="termsandconditions">
            <p><strong>1. Acceptance of Terms of Use and Amendments.</strong></p>
            <p>Each time you use or cause access to this web site, you agree to be bound by these Terms of Use, and as amended from time to time with or without notice to you. In addition, if you are using a particular service on or through this web site, you will be subject to any rules or guidelines applicable to those services and they shall be incorporated by reference into these Terms of Use. Please see our <a title="Privacy Policy" href="privacy-policy" target="_self">Privacy Policy</a>, which is incorporated into these Terms of Use by reference.</p>
            <br>
            <p><strong>2. Our Service.</strong></p>
            ...
            <p>In order to use this web site, you must register on our site, agree to provide truthful information when requested, and be at least the age of eighteen (18) or older. When registering, you explicitly agree to our Terms of Use and as may be modified by us from time to time and available here.</p>
            <br>
            <p><strong>4. Privacy Policy.</strong></p>
            <p>Registration data and other personally identifiable information that we may collect is subject to the terms of our <a title="Privacy Policy" href="privacy-policy" target="_self">Privacy Policy</a>.</p>
            <br>
            ...
            <p>(e) provide any Content that may give rise to our civil or criminal liability or which may consititue or be considered a violation of any local, national or international law, including but not limited to laws relating to copyright, trademark, patent, or trade secrets.</p>
            <br>
            <p><strong>7. Submission of Content on this Web Site.</strong></p>
            ...
            <p>FOR ANYONE WHO FINDS AN ARTICLE BEING PLAGIARIZED OR FOR ANY COPYRIGHT VIOLATION COMPLAINTS PLEASE EMAIL US AT mypetizens@gmail.com . SEND US YOUR COMPLAINT TOGETHER WITH YOUR DOCUMENT(S) AND OTHER SUBSTANTIAL INFORMATION THAT ARE HELPFUL TO PROVE YOUR CLAIM ABOUT THE COPYRIGHT VIOLATION. WE WILL REMOVE ANY ARTICLE IN OUR DATABASE IF PROVEN THAT IT IS VIOLATING ANY COPYRIGHT ISSUE.</p>
            <p>INCLUDE THIS INFORMATION IN YOUR EMAIL:</p>
            <p>» PROVIDE SUFFICIENT DETAILS ABOUT THE COPYRIGHTED WORK THAT YOU BELIEVE HAS BEEN INFRINGED.</p>
            <p>» THE URL(S) OF THE OFFENDING ARTICLE(S) AS FOUND IN petizens.xyz.</p>
            <p>» INCLUDE THE STATEMENT: "I have a good faith belief that use of the copyrighted materials described above as allegedly infringing is not authorized by the copyright owner, its agent, or the law."</p>
            <p>» INCLUDE THE STATEMENT: "I swear, under penalty of perjury, that the information in the notification is accurate and that I am the copyright owner or am authorized to act on behalf of the owner of an exclusive right that is allegedly infringed."</p>
            <p>» YOUR DIGITAL SIGNATURE (You can send us your signature in an image format or scanned document together with the information above.)</p>
            <p>» SEND THE WRITTEN COMMUNICATION MATERIAL TO: mypetizens@gmail.com</p>
            <br>
            ...
            <br>
            <p><strong>15. Miscellaneous Information.</strong></>
