...
<head>
    ...
    <title>Image Upload for Community Posts</title>
</head>

<main class="main-content">
    <div class="listarticlesdiv"><br>
        <h1>Upload File for Community Posts</h1><br>
    </div>

    <form action="includes/uploadmanagercposts.inc" method="post" enctype="multipart/form-data">
