...
<head>
    ...
    <title>Image Upload for Articles</title>
</head>

<main class="main-content">
    <div class="listarticlesdiv"><br>
        <h1>Upload File for Articles</h1><br>
    </div>

    <form action="includes/uploadmanagerarticle.inc" method="post" enctype="multipart/form-data">
        ...
        <p><strong>Note:</strong> Only upload images required for articles here!</p>
    </form>
