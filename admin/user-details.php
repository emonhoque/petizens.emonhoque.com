...
<main class="main-content">
        ...
        <table class="listarticles">
            ...
            ?>
                <tr class="target">
                    ...
                    <td width=200px style="font-size:x-small"> <?php echo $Email; ?> </td>
                    ...
                    <td> <a class="delete-art" href="includes/deleteuser.inc?id=<?php echo $Username; ?>">DELETE</a> </td>
                </tr>
            <?php
            }
            ?>
    ...
    <p class="backtoadminpanel2"> <a href="adduserdetails">Add New User </a></p>
