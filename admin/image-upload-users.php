...
<head>
    ...
    <title>Image Upload for Users</title>
</head>

<main class="main-content">
    <div class="listarticlesdiv"><br>
        <h1>Upload File for Users</h1><br>
    </div>

    <form action="includes/uploadmanagerusers.inc" method="post" enctype="multipart/form-data">
        ...
        <p><strong>Note:</strong> Only upload images required for users here!</p>
    </form>
