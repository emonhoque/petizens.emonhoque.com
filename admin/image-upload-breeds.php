...
<head>
    ...
    <title>Image Upload for Breeds</title>
</head>

<main class="main-content">
    <div class="listarticlesdiv"><br>
        <h1>Upload File for Breeds</h1><br>
    </div>

    <form action="includes/uploadmanagerbreeds.inc" method="post" enctype="multipart/form-data">
        ...
        <p><strong>Note:</strong> Only upload images required for breeds here!</p>
    </form>
